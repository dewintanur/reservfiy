...
<style>
    ...
    .promotion-card, .reservation-card {
        border: none;
    }
    .text-chocolate {
        color: #5B3708;
                ...
                <div class="col-md-3 mb-3">
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex">
                                <a href="{{ route('cafes.show', $cafe->id) }}" class="btn btn-custom detail mt-3">Detail Cafe</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card reservation-card">
                    <div class="row g-0">
                        <div class="col-md-4 position-relative">
                            <div class="card-img-overlay d-flex flex-column justify-content-center align-items-center" style="background-color: transparent;">
                                <h5 class="card-title text-center mb-0" style="font-size: 24px; color: #5B3708;">Last Cafe</h5>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card-img-container p-3 rounded-pill">
                                <img src="{{ asset('storage/' . $reservations->first()->cafe->photo) }}" class="card-img" alt="{{ $reservations->first()->cafe->name }}" style="max-height: 300px;">
                            </div>
                        </div>
                        @if ($reservations->count() > 1)
                            <div class="col-md-4">
                                <div class="card-img-container p-3 rounded-pill">
                                    <img src="{{ asset('storage/' . $reservations->get(1)->cafe->photo) }}" class="card-img" alt="{{ $reservations->get(1)->cafe->name }}" style="max-height: 300px;">
                                </div>
                            </div>
                        @endif
                    </div>
